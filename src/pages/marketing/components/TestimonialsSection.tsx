...
const REVIEWS: Review[] = [
  { name: "Maya R.", role: "Sneaker buyer", gradient: "from-primary to-violet-500", quote: "Bought $600 of sneakers off Instagram. Payment Vault meant I actually slept that night." },
  ...
  { name: "Leon M.", role: "Marketplace flipper", gradient: "from-sky-500 to-blue-500", quote: "I do 10+ deals a week now. Zero chargebacks since I switched to Payment Vault." },
  ...
  { name: "Noor H.", role: "Vinyl trader", gradient: "from-indigo-500 to-purple-500", quote: "Live tracking plus Payment Vault in one place. My buyers trust me way more now." },
...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="overflow-hidden bg-background py-12 md:py-16 lg:py-20">
